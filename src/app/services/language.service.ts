...
const copy: Record<Language, Record<CopyKey, string>> = {
  ...
  es: {
    ...
    'home.eyebrow': 'Creado para pequeñas empresas',
    'home.title': 'Software personalizado para que tu pequeña empresa trabaje mejor.',
    ...
    'home.smallBusiness': 'Enfoque en pequeñas empresas', 'home.benefit1': 'Sistemas prácticos', 'home.benefit2': 'Procesos claros', 'home.benefit3': 'Soporte confiable',
    ...
    'home.whyEyebrow': 'Por qué nosotros', 'home.whyTitle': 'Un socio tecnológico práctico para empresas en crecimiento.',
    'home.ctaEyebrow': 'Listos para mejorar', 'home.ctaTitle': 'Cuéntanos qué está frenando tu negocio.', 'home.write': 'Escríbenos',
    'contact.title': 'Construyamos un sistema que funcione para tu empresa.',
